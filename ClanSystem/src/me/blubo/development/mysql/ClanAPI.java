package me.blubo.development.mysql;
...
public class ClanAPI {
	...
	public ClanAPI() {
		coll = Main.getMongo().getDB("clans").getCollection("clans");
		collPlayers = Main.getMongo().getDB("clans").getCollection("players");
		collInvites = Main.getMongo().getDB("clans").getCollection("invites");
	}
